...
#             qs = (
#                 Employment.objects
#                 .select_related("trainee", "training")
...
#
#         # ----------------------------------------------------------
#         # Check if user is editing an existing outcome
#         # URL example:
#         # /employment/?edit=15
#         # ----------------------------------------------------------
...
#         if request.method == "POST":
#
#             # Hidden field from the edit form
...
#                     outcome.save()
#
#                     # Update WageRecord if salary exists
#                     if outcome.salary:
#
#                         wage_record, created = WageRecord.objects.get_or_create(
#                             employment=outcome,
#                             defaults={
#                                 "trainee": trainee,
...
#                             wage_record.frequency = outcome.wage_frequency
...
def dashboard(request):
    ...
    retention_total = (
        RetentionRecord.objects.count()
    )

    retained = (
        RetentionRecord.objects
        .filter(still_employed=True)
        .count()
    )
